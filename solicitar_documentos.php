...
<body>
<form action="solicitar_documentos_2.php" onsubmit="return validar()" method="post" name="form1" id="form1">
  <p>&nbsp;</p>
  <table width="319" align="center" class="bordes">
    <tr valign="baseline">
      <td colspan="2" align="center" bgcolor="#a4e237" class="negrita">Solicitud de Documentos</td>
    </tr>
    <tr valign="baseline">
