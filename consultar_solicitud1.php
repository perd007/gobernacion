...
<body>
<form action="consultar_solicitud.php" onsubmit="return validar()" method="get" name="form1" id="form1">
  <p>&nbsp;</p>
  <table width="319" align="center" class="bordes">
    <tr valign="baseline">
      <td colspan="2" align="center" bgcolor="#a4e237" class="negrita">Consultar Solicitudes Realizadas</td>
    </tr>
    <tr valign="baseline">
