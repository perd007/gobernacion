...
<body>
<form action="consultar_familiar_2.php" onsubmit="return validar()" method="post" name="form1" id="form1">
  <p>&nbsp;</p>
  <table width="319" align="center" class="bordes">
    <tr valign="baseline">
      <td colspan="2" align="center" bgcolor="#a4e237" class="negrita">Consulta de Familiares</td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td colspan="2" align="center" nowrap="nowrap" bgcolor="#a4e237"><input type="submit" class="negrita" value="Buscar" /></td>
    </tr>
  </table>
