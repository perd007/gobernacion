...
mysql_select_db($database_BD, $BD);
$query_usuarios = "SELECT * FROM usuario where cedula='$usu' ";
...
<form  method="post" name="form1" id="form1">
  <table align="center" class="bordes">
    <tr valign="baseline">
      <td colspan="2" align="center" bgcolor="#a4e237" class="negrita">Consulta de  Solicitud de Documentos</td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" bgcolor="#FFFFFF" align="right">Estado:</td>
      <td align="left" nowrap="nowrap" bgcolor="#FFFFFF" >
	  <?php if($row_solicitud['estado']==1) echo "PROCESADA"; else echo "PENDIENTE";
	   ?>
      </td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="left" nowrap="nowrap" bgcolor="#FFFFFF"><?php echo $row_usuarios['nombre']; ?> <?php echo $row_usuarios['apellido']; ?></td>
    </tr>
    <tr valign="baseline">
      <td align="right" nowrap="nowrap" bgcolor="#FFFFFF" >Cedula del Usuario:</td>
      <td align="left" nowrap="nowrap" bgcolor="#FFFFFF"><?php echo $row_usuarios['cedula']; ?></td>
    </tr>
    <tr valign="baseline">
      <td colspan="2" align="center" nowrap="nowrap" bgcolor="#a4e237">
      <a href="consultar_solicitud.php?cedula=<?php echo $row_empleado['cedula']; ?>"><input name="button" type="button" class="negrita" id="button" value="Regresar" />
      </a>
      </td>
    </tr>
  </table>
